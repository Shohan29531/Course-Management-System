...
<?php foreach($rows as $r) : ?> 
   ...
   <h1 class="lvl"><?php echo 'Student ID : '; echo $r->member_id; ?></h1>
   ...
   <sp class="lvl"><?php echo 'Hall Name : ';?></sp><h2 class="lvl_h2"><?php if($r->hall): echo $r->hall; else: echo "-"; endif;?></h2>
   <sp class="lvl"><?php echo 'Level_Term : ';?></sp><h2 class="lvl_h2"><?php if($r->level_and_term): echo $r->level_and_term; else: echo "-"; endif; ?></h2>
   <sp class="lvl"><?php echo 'Adviser ID : ';?></sp><h2 class="lvl_h2"><?php if($r->adviser_id): echo $r->adviser_id; else: echo "-"; endif; ?></h2>
 ...
 <?php if ($this->session->userdata('username') == $r->username):?>
            <h3><?php echo anchor('site/update_student_info','Update My Info'); ?></h3>    
