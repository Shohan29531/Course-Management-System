...
<?php echo form_open_multipart("upload/do_upload/$temp");?>

<?php echo form_input('file_name','Enter File Name')?>
<?php echo form_submit('submit','upload');?>

<?php //echo anchor('upload/download','Download'); ?>
...
<footer class="container-fluid text-center">
  <p>Life is like a box of chocolate, you never know what you will get</p>
</footer>
