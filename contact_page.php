...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <li class="active"><a href="index.php/login/contact_info">Contact</a></li>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header">Contact with:</h2>
            </div>
            ...
            <div class="col-lg-4 col-sm-6 text-center">
                ...
                <p>Student,Dept. of CSE, BUET</p>
                   <p> Email address: touhidul.shohan@gmail.com</p>
                   Contact Number: 01676529062</p>
            ...
            <div class="col-lg-4 col-sm-6 text-center">
                ...
                <p> Student,Dept. of CSE, BUET </p>
                   <p> Email address: hasibtasiful005@gmail.com</p>
                   Contact Number: 01714200672</p>          
